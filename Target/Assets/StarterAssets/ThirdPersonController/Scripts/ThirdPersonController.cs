    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void AimShoot()
        {
            if (_input.isAiming && Grounded && !_input.sprint)
            {
                ...
                //    Instantiate(arrowProjectile, arrowPoint.position, Quaternion.LookRotation(aimDir, Vector3.up));
                //}
            }
            else
            {
        ...
        public void Shoot()
        {
            ...
            if (_input.isShooting && isRedrawing == false)
            {
                isRedrawing = true;
                Debug.Log("shooting");
                aimDirection= (mouseWorldPosition - arrowPoint.position).normalized;
                Instantiate(arrowProjectile, arrowPoint.position, Quaternion.LookRotation(aimDirection, Vector3.up));
                //arrowPoint.rotation;
            }
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                _cinemachineTargetYaw += _input.look.x * deltaTimeMultiplier;//DefaultSensitivity;
                _cinemachineTargetPitch += _input.look.y * deltaTimeMultiplier; //DefaultSensitivity;
            }
        ...
        {
            DefaultSensitivity = newSensitivity;
        }
